...
- Frontend es multi-page: `/` (feed) y `/upload/` (subida).
...
- UI de upload hace polling de estados para feedback.
- UI de upload muestra preview de transcripcion por submission.
- UI de upload permite reprocess y ver timeline de eventos.
